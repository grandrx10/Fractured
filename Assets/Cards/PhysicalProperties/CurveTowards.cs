...
public class CurveAroundTarget : MonoBehaviour
{
    [FormerlySerializedAs("Duration")] public float duration = 1f;
    [FormerlySerializedAs("TangentInfluence")] public AnimationCurve tangentInfluence;

    private Rigidbody _rb;
    private PhysicalCardObject.PhysicalCardInitState _state;
    ...
    private void Awake()
    {
        ...
        var pco = GetComponent<PhysicalCardObject>();
